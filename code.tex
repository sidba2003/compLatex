...
\frac{
  \begin{array}{c}
    ...
    \Gamma \vdash e_1 : t_1'...\Gamma \vdash e_n : t_n' \\[1ex]
    sizeof(arguments) = sizeof(\Bar{t}) \\[1ex]
    \Bar{t}_1 = t_1'...\Bar{t}_n = t_n'
    
  \end{array}
}{
  \Gamma \{ c \rightarrow C \}, \Delta \vdash \text{var x: $<<$c$>>$ = } c(e_1,...e_n) \text{: $<<$nil$>>$} \dashv \Gamma  \text{'} \{ c \cup x \mapsto c \_inst\}, \Delta
}
\]
